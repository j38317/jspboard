...
//	}
	...
	public String toString() {
		return "BDMemberDto [bm_no=" + bm_no + ", bm_id=" + bm_id + ", bm_pw=" + bm_pw + ", bm_name=" + bm_name
				+ ", bm_addr=" + bm_addr + ", bm_phone=" + bm_phone + ", bm_email=" + bm_email + ", bm_enabled="
				+ bm_enabled + ", bm_role=" + bm_role + "]";
	}
