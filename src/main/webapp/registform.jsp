...
<body>
	...
	<form action="logincontroller.jsp" method="post">
		...
		<table border="1">
			...
			<tr>
				<th>EMAIL</th>
				<td><input type="text" name="bm_email" required="required"></td>
			</tr>
			<tr>
				<th>PHONE</th>
