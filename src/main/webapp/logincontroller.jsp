...
<%@page import="com.moon.app.BDMemberDao"%>
...
<%
	...
	if(command.equals("login")){
		...
		BDMemberDto dto = dao.login(id, pw); // dto에 연결된 db에 있는 id, pw 면 로그인 성공!
...
<%
		...
		request.setAttribute("delectuser", dto);
